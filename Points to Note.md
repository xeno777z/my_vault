1. will the size of github repos keep increasing even if we delete the notes locally but it might stay in the commit graph?
2. we can't show the version if it doesn't exist in commit graph?
3. if user deltes the notes we need to remove it from github not keep it any where in the github storage?
